...
| V2.4 Architecture Intelligence & Agent Governance | PROPOSED | Especificación incorporada en [`49-v2.4-summary.md`](49-v2.4-summary.md) (docs 49–69, ADRs 0032–0045); implementación no iniciada (M0 pendiente de gate de incorporación). |
...
6. **V2.4 Architecture Intelligence & Agent Governance — especificación incorporada, PROPOSED:** docs 49–69 + ADRs 0032–0045 + skills/prompts/schemas de diseño. Pendiente antes de M0: validar enlaces del bundle, baseline Next.js existente, planificar Axum y Django como OSS pendientes.
