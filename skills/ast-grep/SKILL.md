...
---
<!-- Adapted from the official ast-grep agent skill: https://github.com/ast-grep/agent-skill (ast-grep/skills/ast-grep). See ATTRIBUTION.md. -->
...
#### Option A: test with inline rules (quick iterations)
