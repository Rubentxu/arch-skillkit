<!-- Adapted from the official ast-grep agent skill (outline skill): https://github.com/ast-grep/agent-skill. See ATTRIBUTION.md. -->

# ast-grep outline: cheap structural maps before reading source
